...
public class CodeGenerator {
    ...
    public static String scanner(String tip) {
        ...
        if (scanner.hasNext()) {
            ...
            if (StringUtils.isNotEmpty(ipt) && !ipt.trim().equals("")) {
                return ipt;
            }
        }
    ...
    public static void main(String[] args) {
        ...
        String datasourceStr = "jdbc:sqlserver://192.168.0.235:1433;DatabaseName=AuthorityReconstruction";
        String username = "vsofosa";
        String password = "Vsofo235!!!*";
        ...
        // pc.setModuleName(scanner("模块名 artifactId").replace("-", ""));
        pc.setModuleName("codegenerator");
        // pc.setParent(scanner("包名 groupId"));
